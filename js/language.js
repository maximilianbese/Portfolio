const translations = {
  en: {
    ...
    hero_role: "Aspiring Software Developer",
    hero_btn_work: "See my projects",
    hero_btn_contact: "Get in touch",
    ticker_1: "Open to entry-level positions",
    ticker_2: "Aspiring Software Developer",
    ...
    about_word_2: "me",
    about_text:
      "Hey, I'm Maximilian — a passionate software developer in training with a strong focus on frontend technologies. I transitioned into software development because I love building things that are both functional and visually appealing. Every project I take on is a chance to apply what I've learned and push my skills further.",
    about_detail_1: "Based in Lübbecke. Open to remote work and relocation.",
    about_detail_2:
    ...
    contact_text:
      "I'm actively looking for my first position as a software developer. Whether it's an internship, working student role, or junior position — I'm ready to bring my motivation, fresh ideas, and eagerness to grow to your team.",
    ...
    form_btn: "Say Hello ;)",
    footer_role: "Aspiring Software Developer",
  ...
  de: {
    ...
    hero_role: "Angehender Software-Entwickler",
    ...
    contact_text:
      "Ich bin aktiv auf der Suche nach meiner ersten Stelle als Software-Entwickler. Ob Praktikum, Werkstudentenstelle oder Junior-Position — ich bringe Motivation, frische Ideen und den Willen zu wachsen in dein Team.",
    ...
    form_btn: "Sag Hallo ;)",
    footer_role: "Angehender Software-Entwickler",
